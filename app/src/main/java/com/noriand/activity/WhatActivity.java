...
public class WhatActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        //String url = "https://map.kakao.com/?urlX=476035&urlY=1104857&urlLevel=3&map_type=TYPE_SKYVIEW&map_hybrid=true";
        String url = "https://map.kakao.com/?urlX="+x+"&urlY="+y+"&urlLevel=3&map_type=TYPE_SKYVIEW&map_hybrid=true";
