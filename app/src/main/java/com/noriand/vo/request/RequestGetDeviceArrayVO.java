...
public class RequestGetDeviceArrayVO extends RequestVO {
	public int userNo = 0;
	public int deviceNo = 0;

	public RequestGetDeviceArrayVO() {
		kind = "getDeviceArray";
	}

	public void onChangeDeviceArrayForDevice(int deviceNo) {
		kind = "getDeviceArrayForDevice";
